...
function MoreAssets() {
  ...
  return (
    ...
    <div className="text-white">
      <h1 className="font-extrabold font-Oswald text-2xl sm:text-3xl md:text-4xl text-center mb-3 sm:mb-4 mt-2">Similar Assets</h1>
    </div>
      ...
      {assets.map((asset) => (
        ...
        >
          ...
          <div className="px-2 sm:px-4 py-1">
            <h3 className="font-semibold text-sm sm:text-base text-white truncate">{asset.name}</h3>
          </div>
        </div>
      ))}
    </div>
