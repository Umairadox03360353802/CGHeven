    ...
    return (
        <>
            <div className='w-full flex flex-col justify-center items-start px-44 pt-5 pb-16 bg-[#0a1022]'>
                ...
                <p className="mb-1  font-VarelaRound text-gray-300">The user names of all active supporters on <a href="" className='font-medium  underline text-blue-500 hover:text-blue-600  hover:no-underline'>Patreon </a>are automatically shown in the footer of every page on this site.</p>

                <p className='mb-1  font-VarelaRound text-gray-300'>
                    The 30 newest patrons are also shown on the home page.
                </p>
                <p className="mb-1  font-VarelaRound text-gray-300">If you would like your name removed, you can visit your <a href="" className='font-medium  underline text-blue-500 hover:text-blue-600  hover:no-underline'>account page </a>and disable the <span className='className="font-bold text-white'>Footer Credit</span>visibility.</p>
