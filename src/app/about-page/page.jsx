...
function AboutUs() {
    return (
      ...
      <section className="container mx-auto px-4 py-20 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 font-Oswald space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            <Button className="bg-teal-500 hover:bg-teal-700 text-lg px-8 py-6">Explore Assets</Button>
            <Button
              variant="outline"
              className="text-lg px-8 py-6 border-teal-500 text-teal-500 hover:bg-teal-900/50 hover:text-white"
            >
              Join Community
            </Button>
          </div>
        </div>
        <div className="flex-1 relative h-[400px] w-full rounded-xl overflow-hidden shadow-2xl shadow-teal-500/20">
          <img
            src="/main1.png"
      ...
      {/* Categories Section */}
      <section className="container font-Oswald mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            { title: "Digital Tools", icon: <Paintbrush className="h-10 w-10" />, color: "bg-orange-500" },
          ].map((category, index) => (
            <div
              key={index}
            ...
            >
              ...
              <Button
                variant="link"
                className="text-teal-500 p-0 mt-4 group-hover:translate-x-2 transition-transform"
              >
      ...
      <section id="about" className="container mx-auto px-4 py-20 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 relative h-[400px] w-full rounded-xl overflow-hidden shadow-2xl shadow-teal-500/20 order-2 md:order-1">
          <img
            src="/main1.png"
          ...
          <div className="absolute bottom-6 left-6 right-6 flex gap-4">
            <Link
              href="#"
              className="bg-black/60 backdrop-blur-sm p-2 rounded-lg hover:bg-teal-500/80 transition-colors"
            >
        ...
        <div className="flex-1 font-Oswald space-y-6 order-1 md:order-2">
          <h2 className="text-3xl md:text-4xl font-bold">Meet the Founder</h2>
          <h3 className="text-xl md:text-2xl font-semibold text-teal-500">Ammar Khan – Visionary Behind CGHeven</h3>
          ...
          <div className="pt-4">
            <Button className="bg-teal-500 hover:bg-teal-400">Learn More About Ammar</Button>
          </div>
        </div>
      </section>
      ...
      <section id="mission" className="bg-slate-900/80 py-20">
        <div className="container font-Oswald mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            <p className="text-xl text-gray-300">
              ...
              <span className="text-teal-400 font-semibold">high-quality 3D assets available to everyone.</span> Our
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 hover:translate-y-[-5px] transition-all"
              >
      ...
      {/* Features Section */}
      <section id="features" className="container font-Oswald mx-auto px-4 py-20">
        ...
        <div className="mt-20 bg-gradient-to-r from-teal-900/50 to-cyan-900/50 rounded-2xl p-8 md:p-12">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-300 mb-8">
              ...
              <span className="text-teal-400 font-semibold"> access to the best 3D content without limitations.</span>{" "}
              Whether you need assets for
              <span className="text-cyan-400 font-semibold"> games, movies, or advertisements</span>, we're here to
              elevate your work.
            </p>
            <Button className="bg-teal-600 hover:bg-teal-700 text-lg px-8 py-6">Step into CGHeven</Button>
          </div>
        </div>
      </section>

      {/* Software Compatibility */}
      <section className="container mx-auto font-Oswald px-4 py-16">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-teal-900 to-cyan-900  py-20">
        <div className="container mx-auto px-4 font-Oswald text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button className="bg-white text-teal-500 hover:bg-gray-100 text-lg px-8 py-6">Get Started Now</Button>
            <Button variant="outline" className="border-teal-500 text-teal-500 hover:bg-teal-900/50 hover:text-white text-lg px-8 py-6">
              View Asset Library
            </Button>
          </div>
        </div>
